...
| 财务细分+其他因子 | 2136 | `factor/*.parquet` | ✅ 2026-05-11 新增 831 个 |

**因子总计**: 3284 个 Parquet 文件（三时间维度完整 + 估值因子 + 技术因子 + 财务细分/其他因子）
...
**总文件数**: 3284 个因子 Parquet 文件 + 其他数据文件
**总存储大小**: ~28 GB
...
6. **财务细分+其他因子**: 已下载 2136 个，剩余 ~246 个待下载 ✅ 2026-05-11 新增 831 个
7. 期权希腊值数据在试用账号下不可用
