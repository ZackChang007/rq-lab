...
| 财务细分+其他因子 | 916 | `factor/*.parquet` | ✅ 2026-05-08 新增 578 个 |

**因子总计**: 2064 个 Parquet 文件（三时间维度完整 + 估值因子 + 技术因子 + 财务细分/其他因子）
...
**总文件数**: 2064 个因子 Parquet 文件 + 其他数据文件
**总存储大小**: ~7.2 GB
...
6. **财务细分+其他因子**: 已下载 916 个，剩余 ~1467 个待下载 ✅ 2026-05-08 新增 578 个
7. 期权希腊值数据在试用账号下不可用
