...
**流量使用**: 已用 1016.4 / 1024.0 MB（剩余 7.6 MB）
...
**因子总计**: 1106 个 Parquet 文件（三时间维度完整 + 部分技术因子）
...
**总文件数**: 1106 个因子 Parquet 文件 + 其他数据文件
**总存储大小**: ~4.5 GB
...
2. **技术因子**: 已下载 29 个，剩余 ~2680 个待下载
3. 期权希腊值数据在试用账号下不可用
4. 新闻、ESG等模块需要更高级别权限
5. **明日计划**: 继续下载剩余技术因子（约需 80GB，分多天完成）
