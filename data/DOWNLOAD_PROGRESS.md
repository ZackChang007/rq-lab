...
> 更新时间: 2026-04-29 18:45

## 下载状态：✅ 完成（流量已用尽）

**流量使用**: 已用 1041.7 / 1024.0 MB (超限 17.7 MB)
...
**总文件数**: 431 个 Parquet 文件 + 26 个 JSON 文件
**总存储大小**: ~3.8 GB
...
1. 因子数据只下载了12个技术因子，如需更多因子请按需下载
2. 期权希腊值数据在试用账号下不可用
3. 新闻、ESG、宏观等模块需要更高级别权限
4. 流量已用尽，无法继续下载更多数据
