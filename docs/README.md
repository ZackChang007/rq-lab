...
| **聚宽参考** | JoinQuant 因子研究参考 | [docs/joinquant/](./joinquant/JOINQUANT_FACTOR_RESEARCH.md) |
...
### 聚宽参考
- `JOINQUANT_FACTOR_RESEARCH.md` - 聚宽因子研究功能参考：因子定义、数据处理、单因子分析
...
- `FACTOR_RESEARCH_ADVANCED_FEATURES.md` - 因子研究高级功能调研：因子挖掘、合成、组合分析、回测对接
